...
function (_Component) {
  ...
  function When() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateTime", function () {
      ...
      var timeDiff = Math.abs(date2.getTime() - time.getTime());
      var diffDays = Math.ceil(timeDiff / (1000 * 3600 * 24)); // on hour chanage, update hours and shuffle state
...
//# sourceMappingURL=index.js.c00fec7d40576ac20485.hot-update.js.map